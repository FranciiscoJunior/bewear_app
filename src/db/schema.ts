...
export const cartTable = pgTable("cart", {
  ...
  userId: text("user_id")
    .notNull()
    .references(() => userTable.id, { onDelete: "cascade"}),
  shippingAddressId: uuid("shipping_adress_id").references(
...
export const orderTable = pgTable("order", {
  ...
  userId: text("user_id")
    .notNull()
    .references(() => userTable.id, {onDelete: "cascade"}),
  shippingAddressesId: uuid("shipping_address_id")
    .notNull()
...
export const orderRelations =  relations(orderTable, ({one, many }) => ({
  ...
  shippingAddress: one(shippingAddressTable, {
    fields: [orderTable.shippingAddressesId],
    references: [shippingAddressTable.id],
  }),
...
export const orderItemsRelationes = relations(orderItemTable, ({ one }) => ({
